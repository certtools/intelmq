...
python -m bots.outputs.file.file archive &
#python -m bots.outputs.mongodb.mongodb mongodb &

echo -en "\ec"
echo ""
echo ""
echo "Check /opt/intelmq/src/archive/events.txt with following command:"
echo ""
echo "tail -f /opt/intelmq/src/archive/events.txt"
echo ""
