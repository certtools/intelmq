...
if os.path.isdir("/opt/intelmq"):
    print()
    print('IntelMQ seems to be already installed due the'
          'existence of /opt/intelmq directory. '
          'If you continue the directory will be overwritten.')
...
setup(
    ...
    data_files=[
      ...
      ('/opt/intelmq/bin/', ['intelmq/bin/intelmqctl']),
      ('/opt/intelmq/docs/', [
        'docs/UserGuide.md',
        'docs/DevGuide.md',
