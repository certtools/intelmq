...
class DateTime(String):
    ...
    @staticmethod
    def from_isoformat(value: str, return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
        Parses datetime string in ISO format. Naive datetime strings (without timezone) are assumed to be in UTC.
        ...
        return dtvalue if return_datetime else value

    @staticmethod
    def from_epoch_millis(value: Union[int, str], return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
        ...
        """
        bytecount = len(str(value))
        int_tstamp = int(value)
        if bytecount == 10:
            return DateTime.from_timestamp(int_tstamp, return_datetime=return_datetime)
        if bytecount == 12:
            return DateTime.from_timestamp(int_tstamp // 100, return_datetime=return_datetime)
        if bytecount == 13:
            return DateTime.from_timestamp(int_tstamp // 1000, return_datetime=return_datetime)

    @staticmethod
    def from_timestamp(value: Union[int, float, str], return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
        Returns ISO formatted datetime from given timestamp.
        """
        value = datetime.datetime.fromtimestamp(float(value), datetime.timezone.utc)
        return value if return_datetime else value.isoformat()

    @staticmethod
    def from_windows_nt(value: Union[int, str], return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
        ...
        dtime = epoch + datetime.timedelta(seconds=int(value) * 10 ** -7)
        return dtime if return_datetime else dtime.isoformat()
    ...
    @staticmethod
    def from_format(value: str, format: str, return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
    ...
    @staticmethod
    def from_format_midnight(value: str, format: str, return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
    ...
    @staticmethod
    def from_fuzzy(value, return_datetime: bool = False) -> Union[datetime.datetime, str]:
        value = dateutil.parser.parse(value, fuzzy=True)
        if not value.tzinfo:
            value = value.replace(tzinfo=datetime.timezone.utc)
        else:
    ...
    def convert(value, format='fuzzy') -> str:
        ...
        * fuzzy (or None): Use dateutils' fuzzy parser, default if no specific parser is given
        ...
        if format.startswith('from_format|'):
            return DateTime.from_format(value, format=format[12:])
        elif format.startswith('from_format_midnight|'):
            return DateTime.from_format_midnight(value, format=format[21:])
        else:
    ...
    def parse_utc_isoformat(value: str, return_datetime: bool = False) -> Union[datetime.datetime, str]:
        """
        This function is replaced by 'from_isoformat' function.
        The original name is kept for backwards compatibility and will be removed in version 4.0.
        """
        # TODO remove in IntelMQ 4.0
        warnings.warn("Function 'parse_utc_isoformat' is deprecated and will be removed in version 4.0."
                      "Use 'from_isoformat' instead.", DeprecationWarning)
        return DateTime.from_isoformat(value=value, return_datetime=return_datetime)

    @staticmethod
    def convert_from_format(value: str, format: str) -> str:
        """
        This function is replaced by 'from_format' function.
        The original name is kept for backwards compatibility and will be removed in version 4.0.
        """
        # TODO remove in IntelMQ 4.0
        warnings.warn("Function 'convert_from_format' is deprecated and will be removed in version 4.0."
                      "Use 'from_format' instead.", DeprecationWarning)
        return DateTime.from_format(value=value, format=format)

    @staticmethod
    def convert_from_format_midnight(value: str, format: str) -> str:
        """
        This function is replaced by 'from_format_midnight' function.
        The original name is kept for backwards compatibility and will be removed in version 4.0.
        """
        # TODO remove in IntelMQ 4.0
        warnings.warn("Function 'convert_from_format_midnight' is deprecated and will be removed in version 4.0."
                      "Use 'from_format_midnight' instead.", DeprecationWarning)
        return DateTime.from_format_midnight(value=value, format=format)

    @staticmethod
    def convert_fuzzy(value) -> str:
        """
        This function is replaced by 'from_fuzzy' function.
        The original name is kept for backwards compatibility and will be removed in version 4.0.
        """
        # TODO remove in IntelMQ 4.0
        warnings.warn("Function 'convert_fuzzy' is deprecated and will be removed in version 4.0."
                      "Use 'from_fuzzy' instead.", DeprecationWarning)
        return DateTime.from_fuzzy(value=value)


DateTime.TIME_CONVERSIONS = {
    'timestamp': DateTime.from_timestamp,
    'windows_nt': DateTime.from_windows_nt,
    'epoch_millis': DateTime.from_epoch_millis,
    'from_format': DateTime.from_format,
    'from_format_midnight': DateTime.from_format_midnight,
    'utc_isoformat': DateTime.from_isoformat,
    'fuzzy': DateTime.from_fuzzy,
    None: DateTime.from_fuzzy,
}
