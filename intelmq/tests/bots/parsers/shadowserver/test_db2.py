...
EXAMPLE_REPORT = {"feed.name": "ShadowServer Open-DB2",
                  "raw": utils.base64_encode(EXAMPLE_FILE),
                  "__type": "Report",
                  "time.observation": "2015-01-01T00:00:00+00:00",
                  }
EVENTS = [{'__type': 'Event',
           'feed.name': 'ShadowServer Open-DB2',
           ...
           'source.port': 523,
           'destination.reverse_dns': 'server1.net',
           'time.observation': '2015-01-01T00:00:00+00:00',
          ...
          {'__type': 'Event',
           ...
           'destination.reverse_dns': 'kronos.net',
           'time.observation': '2015-01-01T00:00:00+00:00',
...
class TestShadowserverParserBot(test.BotTestCase, unittest.TestCase):
    ...
    def set_bot(cls):
        ...
        cls.sysconfig = {'feedname': 'Open-DB2'}
