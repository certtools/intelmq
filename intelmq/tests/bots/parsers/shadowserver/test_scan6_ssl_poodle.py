...
with open(os.path.join(os.path.dirname(__file__), 'testdata/scan6_ssl_poodle.csv')) as handle:
    EXAMPLE_FILE = handle.read()
EXAMPLE_LINES = EXAMPLE_FILE.splitlines()

EXAMPLE_REPORT = {'feed.name': 'SSLv3/POODLE Vulnerable Servers',
                  "raw": utils.base64_encode(EXAMPLE_FILE),
                  "__type": "Report",
                  "time.observation": "2021-01-01T00:00:00+00:00",
                  "extra.file_name": "2021-01-01-scan6_ssl_poodle-test-geo.csv",
                  }
EVENTS = [{'classification.taxonomy': 'vulnerable',
           ...
           'feed.name': 'SSLv3/POODLE Vulnerable Servers',
