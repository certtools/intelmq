...
EVENTS = [{'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "Hardware: x86 Family 6 Model 8 Stepping 6 AT/AT COMPATIBLE - Software: Windows 2000 Version 5.0 (Build 2195 Uniprocessor Free)", "sysname": "ORSONKA", "version": 2}',
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "ADSL Modem", "sysname": "tc", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "Linux ADSL2PlusRouter 2.6.19 #7 Tue Apr 9 17:06:16 CST 2013 mips", "sysname": "TD5130", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "Linux R6100 2.6.31 #1 Tue Jun 4 06:50:58 EDT 2013 mips MIB=01a01", "sysname": "Unknow", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "110TC1", "sysname": "Beetel", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "BCW710J <<HW_REV: 1.01; VENDOR: Bnmux; BOOTR: 2.4.0alpha14; SW_REV: 5.30.5; MODEL: BCW710J>>", "sysname": "CableHome", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "Linux WNR1000v2 2.6.15 #199 Thu Jan 28 09:49:57 CST 2010 mips MIB=01a01", "sysname": "Unknow", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'snmp',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "sic": 0, "sysdesc": "D-Link Wireless Voice Gateway <<HW_REV: B4; VENDOR: D-Link; BOOTR: 2.4.0beta1; SW_REV: 1.1.0.4; MODEL: DCM-704>>", "sysname": "CableHome", "version": 2}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'snmp',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
