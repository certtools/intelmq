...
EVENTS = [{'__type': 'Event',
          ...
          {'__type': 'Event',
           'classification.identifier': 'qotd',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "quote": "When a stupid man is doing something he is ashamed of, he always declares?? that it is his duty. George Bernard Shaw (1856-1950)??", "sic": 0, "tag": "qotd"}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'qotd',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'qotd',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "quote": "_The secret of being miserable is to have leisure to bother about whether?? you are happy or not.  The cure for it is occupation._?? George Bernard Shaw (1856-1950)??", "sic": 0, "tag": "qotd"}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'qotd',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           'classification.identifier': 'qotd',
           'classification.type': 'vulnerable service',
           'extra': '{"naics": 0, "quote": "_We have no more right to consume happiness without producing it than to?? consume wealth without producing it._ George Bernard Shaw (1856-1950)??", "sic": 0, "tag": "qotd"}',
           'feed.name': 'ShadowServer QOTD',
           'protocol.application': 'qotd',
           'protocol.transport': 'udp',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
