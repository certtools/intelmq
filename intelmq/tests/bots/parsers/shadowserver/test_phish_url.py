...
EVENTS = [
{
   ...
   'extra.host' : 'priceless-pare.example.net',
   ...
   'extra.url' : 'https://priceless-pare.example.net/Postal-/acec6/',
   'feed.name' : 'Phish URL',
...
},
{
   ...
   'classification.taxonomy' : 'fraud',
   'classification.type' : 'phishing',
   'extra.host' : 'mailyahooattt.example.net',
   'extra.source' : 'openphish.com',
   'extra.source.sector' : 'Professional, Scientific, and Technical Services',
   'extra.url' : 'https://mailyahooattt.example.net/',
   'feed.name' : 'Phish URL',
...
},
{
   ...
   'classification.taxonomy' : 'fraud',
   'classification.type' : 'phishing',
   'extra.host' : 'www.example.net',
   'extra.source' : 'openphish.com',
   'extra.source.naics' : 519130,
   'extra.source.sector' : 'Communications, Service Provider, and Hosting Service',
   'extra.url' : 'https://www.example.net/viewer/vbid-730ec2b1-omsttuer',
   'feed.name' : 'Phish URL',
