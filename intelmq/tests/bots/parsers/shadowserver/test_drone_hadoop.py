...
EVENTS = [{'__type': 'Event',
           ...
           'destination.port': 80,
           'extra': '{"connection_count": 1, "family": "dorkbot", "naics": 541690, "os.name": "Windows", "os.version": "2000 SP4, XP SP1+", "public_source": "AnubisNetworks", "sic": 874899, "tag": "sinkhole"}',
          ...
          {'__type': 'Event',
           ...
           'destination.url': 'http://015.example.com/',
           'destination.geolocation.cc': 'NL',
           'destination.ip': '94.75.228.147',
           'extra': '{"connection_count": 1, "destination.naics": 517510, "destination.sector": "Commercial Facilities", "destination.sic": 737415, "os.name": "WINXP"}',
           'malware.name': 'spyeye',
           'raw': utils.base64_encode('\n'.join([RECONSTRUCTED_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'destination.port': 80,
           'extra': '{"naics": 541690, "os.name": "Windows", "os.version": "XP SP1+, 2000 SP3 (2)", "sic": 874899}',
          ...
          {'__type': 'Event',
           ...
           'extra': '{"connection_count": 1, "destination.sector": "Communications", "os.name": "Windows", "os.version": "2000 SP4, XP SP1+", "public_source": "SecurityScorecard"}',
           'malware.name': 'sinkhole',
           'protocol.transport': 'tcp',
           'raw': utils.base64_encode('\n'.join([RECONSTRUCTED_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'destination.ip': '74.208.164.166',
           'destination.port': 443,
           'extra': '{"connection_count": 1, "destination.naics": 517510, "destination.sector": "Commercial Facilities", "destination.sic": 737415, "id": "mu6lam0neitheenahz6Phee6lee1zaelahtha2xu", "naics": 541690, "os.name": "Windows", "os.version": "2000 SP4, XP SP1+", "sic": 874899}',
           'malware.name': 'sinkhole',
           'protocol.transport': 'tcp',
           'raw': utils.base64_encode('\n'.join([RECONSTRUCTED_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'destination.ip': '87.106.24.200',
           'destination.port': 443,
           'extra': '{"destination.sector": "Communications", "os.name": "Windows", "os.version": "2000 SP4, XP SP1+", "sector": "Communications"}',
           'malware.name': 'sinkhole',
           'protocol.transport': 'tcp',
           'raw': utils.base64_encode('\n'.join([RECONSTRUCTED_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'destination.ip': '87.106.24.200',
           'destination.port': 443,
           'extra': '{"connection_count": 1, "destination.naics": 517510, "destination.sector": "Communications", "destination.sic": 737415, "os.name": "Windows", "os.version": "XP/2000 (RFC1323+, w+, tstamp+)"}',
           'malware.name': 'sinkhole',
           'protocol.transport': 'tcp',
           'raw': utils.base64_encode('\n'.join([RECONSTRUCTED_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'destination.ip': '74.208.164.166',
           'destination.port': 80,
           'extra': '{"connection_count": 1, "destination.naics": 517510, "destination.sector": "Communications", "destination.sic": 737415, "naics": 541690, "os.name": "Windows", "os.version": "XP SP1+, 2000 SP3 (2)", "sic": 874899}',
           'malware.name': 'sinkhole',
           'protocol.transport': 'tcp',
           'raw': utils.base64_encode('\n'.join([RECONSTRUCTED_LINES[0],
