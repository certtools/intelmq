...
EVENTS = [{'__type': 'Event',
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.0.8077)"}',
           'feed.name': 'ShadowServer QOTD',
           'malware.name': 'caphaw',
           'protocol.application': 'http',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.0.7357)"}',
           'feed.name': 'ShadowServer QOTD',
           'malware.name': 'caphaw',
           'protocol.application': 'http',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.0.9121)"}',
           'feed.name': 'ShadowServer QOTD',
           'malware.name': 'caphaw',
           'protocol.application': 'http',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; BRI/1)"}',
           'feed.name': 'ShadowServer QOTD',
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; WOW64; .NET CLR 3.5.21022)"}',
           'feed.name': 'ShadowServer QOTD',
           'malware.name': 'citadel-b54',
           'protocol.application': 'http',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; AskTB5.6)"}',
           'feed.name': 'ShadowServer QOTD',
           'malware.name': 'citadel-b54',
           'protocol.application': 'http',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; AskTbFWV5/5.11.3.15590)"}',
           'feed.name': 'ShadowServer QOTD',
           'malware.name': 'citadel-b54',
           'protocol.application': 'http',
           'raw': utils.base64_encode('\n'.join([EXAMPLE_LINES[0],
          ...
          {'__type': 'Event',
           ...
           'extra': '{"naics": 0, "sic": 0, "user_agent": "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; .NET4.0C)"}',
           'feed.name': 'ShadowServer QOTD',
