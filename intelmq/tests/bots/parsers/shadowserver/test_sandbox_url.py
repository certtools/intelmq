...
EVENTS = [
{
   ...
   'extra.host' : 'www.msftncsi.com',
   'extra.method' : 'GET',
   'extra.url' : 'http://www.msftncsi.com/ncsi.txt',
...
},
{
   ...
   'classification.taxonomy' : 'malicious-code',
   'classification.type' : 'malware-distribution',
   'extra.host' : 'www.download.windowsupdate.com',
   'extra.method' : 'GET',
   'extra.url' : 'http://www.download.windowsupdate.com/msdownload/update/v3/static/trustedr/en/authrootstl.cab',
...
},
{
   ...
   'classification.taxonomy' : 'malicious-code',
   'classification.type' : 'malware-distribution',
   'extra.host' : 'crl.microsoft.com',
   'extra.method' : 'GET',
   'extra.url' : 'http://crl.microsoft.com/pki/crl/products/MicTimStaPCA_2010-07-01.crl',
   'extra.user_agent' : 'Microsoft-CryptoAPI/6.1',
   'feed.name' : 'Sandbox URL',
