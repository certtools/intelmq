...
with open(os.path.join(os.path.dirname(__file__), 'data_type_multiple_header.csv')) as handle:
...
class TestMultipleHeaderCsvParserBot(test.BotTestCase, unittest.TestCase):
    """
