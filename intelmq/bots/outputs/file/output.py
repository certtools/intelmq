    ...
    def check(parameters):
        ...
        if not os.path.exists(dirname) and '{ev' not in dirname:
            ...
            try:
                ...
                return [["error", f"Directory ({dirname}) of parameter 'file' does not exist and could not be created."]]
            else:
                return [["info", f"Directory ({dirname}) of parameter 'file' did not exist, but has now been created."]]
