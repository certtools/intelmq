...
class MailGatherOutputBot(Bot):
    ...
    def process(self):
        ...
        message.add("destination.abuse_contact",u"edvard.rejthar+test_abusemail@nic.cz") # XXX nevim, zda nepouzit https://github.com/certtools/intelmq/blob/master/docs/Harmonization-fields.md treba destination.account, nebo source.account
        self.logger.warning("ZPRAVA END..")

        field = message["destination.abuse_contact"]
