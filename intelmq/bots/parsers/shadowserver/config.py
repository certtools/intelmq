...
ssl_scan = {
    ...
    'constant_fields': {
        'classification.type': 'vulnerable service',
        'classification.identifier': 'sslpoodle',
        'feed.code': 'shadowserver-ssl-poodle-scan',
...
ssl_freak_scan = {
    ...
    'constant_fields': {
        'classification.type': 'vulnerable service',
        'classification.identifier': 'sslfreak',
...
open_ldap = {
    ...
    'constant_fields': {
        ...
        'classification.type': 'vulnerable service',
        'feed.code': 'shadowserver-openldap',
