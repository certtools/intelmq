...
spam_url = {
    ...
    'optional_fields': [
        ('source.url', 'url', convert_http_host_and_url, True),
        ('source.fqdn', 'host', validate_fqdn),
        ('extra.relay.ip', 'src_ip', validate_ip),
        ('extra.relay.asn', 'src_asn', invalidate_zero),
        ('extra.relay.geolocation.cc', 'src_geo', validate_to_none),
        ('extra.relay.geolocation.region', 'src_region', validate_to_none),
        ('extra.relay.geolocation.city', 'src_city', validate_to_none),
        ('extra.relay.naics', 'src_naics', invalidate_zero),
        ('extra.relay.sector', 'src_sector', validate_to_none),
        ('source.asn', 'asn', invalidate_zero),
        ('source.geolocation.cc', 'geo'),
        ('source.geolocation.region', 'region'),
        ('source.geolocation.city', 'city'),
